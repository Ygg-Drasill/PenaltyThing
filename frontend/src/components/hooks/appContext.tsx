...
import { useNotificationServiceGetFiltered, useTeamServiceGetTeamsByUserId, useUserServiceGetUser } from "../openapi/queries";
...
export function AppContextProvider (props: {children: ReactNode, userId: string, currentTeamId: string, setCurrentTeamId: React.Dispatch<SetStateAction<string>>}) {
    ...
    const notificationsResult = useNotificationServiceGetFiltered({userId: props.userId, filter: []}, null, {refetchInterval: 5000})
