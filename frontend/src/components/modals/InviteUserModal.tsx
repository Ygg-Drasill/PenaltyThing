import { Autocomplete, Box, Button, Divider, LinearProgress, Modal, TextField, Typography } from "@mui/material";
import { ModalBase } from "./ModalBase";
import { useInvitationServiceCreateInvitation, UserServiceGetUserAllQueryResult, useUserServiceGetUserAll } from "../openapi/queries";
